...
local brightness = function(args)
    ...
    redflat.float.brightness:chande_with_brightnessctl(args) -- use brightnessctl utility
end
...
function hotkeys:init(args)
    ...
    self.raw.root = {
        ...
        },
        {
            ...
            redflat.widget.upgrades:update(true)
        end,
        ...
        {
            {}, "XF86AudioRaiseVolume", function() volume_raise({step = 655 * 5}) end,
        ...
        {
            {}, "XF86AudioLowerVolume", function() volume_lower({step = 655 * 5}) end,
    ...
    self.mouse.client = awful.util.table.join(
            awful.button({ env.mod }, 1, function(c)
